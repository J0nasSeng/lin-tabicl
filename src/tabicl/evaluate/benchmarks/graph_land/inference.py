...
from tabicl.evaluate.benchmarks.graph_land.dataset import Dataset
...
def evaluate_dataset(
	...
	*,
	...
	X_train, y_train, X_test, y_test, train_mask, test_mask = _masked_arrays(dataset)
